            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-8 text-gray-900">
                    ...
                    <div class="flex justify-between items-center mb-8">
                        <h3 class="text-xl font-bold text-gray-800">Edit Snack Details</h3>
                    ...
                    <form action="{{ route('snacks.update',$snack->id) }}" method="POST" class="space-y-6 max-w-2xl mx-auto">
                        @csrf
                        @method('PUT')

                        <div>
                            <label for="title" class="block text-sm font-medium text-gray-700 mb-1">Title</label>
                            <input type="text" name="title" id="title" value="{{ $snack->title }}" class="block w-full rounded-lg border-gray-300 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm" placeholder="Enter snack title">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative rounded-md shadow-sm">
                                ...
                                <input type="number" step="0.01" name="price" id="price" value="{{ $snack->price }}" class="block w-full rounded-lg border-gray-300 pl-7 shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm" placeholder="0.00">
                            </div>
                        </div>
